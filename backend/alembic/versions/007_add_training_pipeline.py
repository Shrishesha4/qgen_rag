...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("vetting_log_id", sa.String(36), sa.ForeignKey("vetting_logs.id", ondelete="SET NULL")),
        sa.Column("chosen_question_id", sa.String(36), sa.ForeignKey("questions.id", ondelete="SET NULL")),
        sa.Column("rejected_question_id", sa.String(36), sa.ForeignKey("questions.id", ondelete="SET NULL")),
    ...
    op.create_table(
        ...
        sa.Column("parent_version_id", sa.String(36), sa.ForeignKey("model_versions.id", ondelete="SET NULL")),

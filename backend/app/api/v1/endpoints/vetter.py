...
async def get_questions_for_vetting(
    ...
    # Keep vetting/question counts consistent across subject and topic views by
    # using the same subject-level dataset for all teachers.
    # When teacher_id is explicitly provided above, that filter is already applied.
